              ...
              <form action="" method='POST' enctype="multipart/form-data">
                ...
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" name="banner_name" class="form-control" id="exampleInputEmail1" placeholder="Enter Banner Name" value="{{$banner->banner_name}}">
                </div>
                <div class="form-group">
                    ...
                    <div>
                      <img id="imagePreview" src="{{url('upload/product').'/'.$banner->banner_image}}" alt="Your Image" style="display: block; max-width: 200px; max-height: 200px; margin-top: 10px;" />
                    </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="banner_alt" class="form-control" id="exampleInputEmail1" placeholder="Enter Banner alt text" value="{{$banner->banner_alt}}">
                  </div>

      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          ...
          <ol class="breadcrumb float-sm-right">
            <a href="{{url('admin/add_category')}}"><button class="btn btn-primary">Add Category</button></a>
          </ol>
        </div><!-- /.col -->
      </div><!-- /.row -->
    </div><!-- /.container-fluid -->
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><img src="{{url('public/upload/product/'. $rec->cat_img)}}" alt="#" class="imgpreview"></td>
                    <td>{{$rec->meta_tittle}}</td>
                    <td>{{($rec->status)==1? 'Active':'Disabled' }}</td>
                    <td><a href="{{ url('/admin/delete_category/'.$rec->id)  }}" onclick="return confirm('Are you sure! You will also LOSE THE PRODUCTS under this category')"><button class="btn btn-danger" >Delete</button></a>
                        <a href="{{ url('/admin/edit_category/'.$rec->id ) }}"> <button  class="btn btn-success">Edit</button></a>
                    </td>

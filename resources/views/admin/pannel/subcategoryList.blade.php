      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          ...
          <ol class="breadcrumb float-sm-right">
            <a href="{{url('admin/add_subcategory')}}"><button class="btn btn-primary">Add Sub Category</button></a>
          </ol>
        </div><!-- /.col -->
      </div><!-- /.row -->
    </div><!-- /.container-fluid -->
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><a href="{{ url('/admin/delete_subcategory/'.$rec->id)  }}" onclick="return confirm('Are you sure! You will also LOSE THE PRODUCTS under this category')"><button class="btn btn-danger" >Delete</button></a>
                        <a href="{{ url('/admin/edit_subcategory/'.$rec->id ) }}"> <button  class="btn btn-success">Edit</button></a>
                    </td>
